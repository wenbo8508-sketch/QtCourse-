...
{//点击工具栏“关于”按钮，弹出About对话框显示个人信息
//====== 下面的内容改成你自己的 ======
    QString myName ="宋文博";         //姓名
    QString myNo   ="2023412010218";  //学号
    QString myClass="24软件工程1班";   //班级
//=================================
    QString info;
    info +="<h3>samp2_4 富文本编辑器</h3>";
    info +="<p>开发人员信息：</p>";
    info +="<table cellspacing=\"6\">";
    info +="<tr><td><b>姓名：</b></td><td>"+myName+"</td></tr>";
    info +="<tr><td><b>学号：</b></td><td>"+myNo+"</td></tr>";
    info +="<tr><td><b>班级：</b></td><td>"+myClass+"</td></tr>";
    info +="</table>";

    QMessageBox::about(this,tr("samp2_4"),info);//About对话框，自带OK按钮
}
